  ...
  return (
    <div className="container pb-32 pt-24 max-w-3xl">
      ...
      <Section title="Формат">
        ...
        <p>
          Каждая встреча — это две партии (как в прошлом сезоне). Если каждый
          выигрывает по партии, фиксируется ничья.
        </p>
      </Section>
      ...
      <Section title="Очки и таблица">
        <p>
          За победу в матче начисляется 3 очка, за ничью — 2 очка, за поражение
          — 1 очко.
        </p>
        <p>
